...
enum class MenuItem(val title: String) {
    ...
    EASY_FOOD_SUGGESTION_GAME("Suggest 10 Random Easy Meals"),
    PREPARATION_TIME_GUESSING_GAME("Guess Meal Preparation Time"),
    ...
    INGREDIENT_GAME("Guess the Meal Ingredient Game"),
